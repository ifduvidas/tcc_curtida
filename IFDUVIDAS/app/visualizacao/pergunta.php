...
<div class="ui sixteen wide divided grid">
 ...
 <div class="ui button" onclick="">
    <a href="../controlador/Usuarios.php?acao=curtir&id_pergunta=<?=$pergunta['id_pergunta']?>">
     <i class="heart icon">
    </i> Like
    </a>
  </div>
...
<?php }; ?>
  ...
  <a href="../controlador/Usuarios.php?acao=deletarComentario&id_comentario=<?=$comentario['id_comentario']?>&id_pergunta=<?=$pergunta['id_pergunta']?>">
...
<?php }; ?>
  ...
  <a href="../controlador/Usuarios.php?acao=deletarResposta&id_resposta=<?=$resposta['id_resposta']?>&id_pergunta=<?=$pergunta['id_pergunta']?>">
    <button class="circular ui negative icon button">
  <i class="trash alternate icon"></i>
    </button>
  </a>
